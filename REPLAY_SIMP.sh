...
#
# A) Perform manual test simplifications.
#
...
#
# B) Check if some other MariaDB version suffers from the same problem.
#
# C) Check if some MariaDB with fixes for that problem ....
#
#
...
PROT="replay_simp-""$CASE""-""$BASEDIR1_NAME"".prt"
