...
# HINT:
# This build variant is frequent used. It is
# - comfortable for the analysis of bugs because of no compiler optimization
...
# - medium till less good for automatic simplification of tests
...
# But we go here with no optimization.
