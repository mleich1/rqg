...
# HINT:
# This build variant is rare used. It is
# - uncomfortable for the analysis of bugs because of compiler optimization
...
# - medium till very good for automatic simplification of tests
#
...
USAGE="$USAGE Build without debug, serious optimization for InnoDB and most of mariadb.\n"
