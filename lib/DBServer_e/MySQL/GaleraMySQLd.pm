...
#
#
# This module is a derivate of lib/DBServer_e/MySQL/GaleraMySQLd.pm developed by
...
# the current package gets provided as 'DBServer_e::MySQL::GaleraMySQLd1'.
#
# 2019-09 Matthias Leich
#

package DBServer_e::MySQL::GaleraMySQLd;
...
sub new {
    ...
    foreach my $i (0..$self->[GALERA_MYSQLD_NODE_COUNT]-1) {
        ...
        $self->nodes->[$i] = DBServer_e::MySQL::MySQLd->new(
...
sub startServer {
    ...
    foreach my $i (0..$self->[GALERA_MYSQLD_NODE_COUNT]-1) {
        return STATUS_FAILURE if $self->nodes->[$i]->startServer != STATUS_OK;
...
#   return STATUS_FAILURE if $self->waitForNodeSync != STATUS_OK;
}
