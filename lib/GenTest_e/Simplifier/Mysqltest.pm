...
package GenTest_e::Simplifier::Mysqltest;
        ...
        if ($csv->parse($_)) {
            ...
            if (($command eq 'Connect') && ($simplifier->[SIMPLIFIER_USE_CONNECTIONS])) {
                ...
                if ($command eq 'Init DB') {
                    ...
                    # which seem to change the default database to the database named at the
                    # end of the line. Replace this by USE <database>
...
#
# This is an implementation of the ddmin algorithm, as described in
