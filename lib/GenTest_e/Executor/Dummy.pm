...
package GenTest_e::Executor::Dummy;
...
use GenTest_e::Translator::MysqlDML2javadb;
use GenTest_e::Translator::Mysqldump2javadb;
use GenTest_e::Translator::MysqlDML2pgsql;
use GenTest_e::Translator::Mysqldump2pgsql;
...
sub execute {
    ...
    if ($self->dsn() =~ m/javadb/) {
        @pipe = (GenTest_e::Translator::Mysqldump2javadb->new(),
                 GenTest_e::Translator::MysqlDML2javadb->new());

    } elsif ($self->dsn() =~ m/postgres/) {

        @pipe = (GenTest_e::Translator::Mysqldump2pgsql->new(),
                 GenTest_e::Translator::MysqlDML2pgsql->new());
	...
	return new GenTest_e::Result(query => $query,
                               status => STATUS_OK);
}
