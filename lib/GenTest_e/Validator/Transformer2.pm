...
package GenTest_e::Validator::Transformer2;
...
use GenTest_e::SimPipe::Oracle::FullScan;
use GenTest_e::SimPipe::Testcase;
...
sub transform {
	...
	my $oracle = GenTest_e::SimPipe::Oracle::FullScan->new( dsn => $executor->dsn() );
	...
	my $testcase = GenTest_e::SimPipe::Testcase->newFromDSN($executor->dsn(), [ $simplified_query ] );
