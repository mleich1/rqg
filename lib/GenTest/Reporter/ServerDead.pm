...
package GenTest::Reporter::ServerDead;
...
# 2. ServerDead will be called if ever only around end of GenTest.
#
# Typical use case:
...
#   Worst and also frequent seen case around GenTest end:
...
sub callbackReport {
    my $output = GenTest::CallbackPlugin::run("serverdead");
    say("$output");
