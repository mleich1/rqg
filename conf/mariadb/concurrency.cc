...
$combinations = [
   [
      '
         --gendata=conf/mariadb/concurrency.zz
         --gendata_sql=conf/mariadb/concurrency.sql
         --grammar=conf/mariadb/concurrency.yy
         --engine=Innodb
         ...
         --mysqld=--loose-innodb_change_buffering_debug=1
         --duration=300
         --sqltrace=MarkErrors
         --seed=random
      '
