...
$combinations = [ $grammars,
  ...
  [
    ...
    #    --> CrashRecovery higher than RestartConsistency (uses Shutdown)
    # 2. Shorter duration than default if the main checking happens around or after the end
    #    of GenTest. --> CrashRecovery and RestartConsistency
