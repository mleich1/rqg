...
if      (defined $config_file and defined $verdict_file) {
    ...
    # $rqg_workdir/rqg.log        --> the log file to be used here
...
sub help() {
   ...
   "    perl verdict.pl [[--batch_config=<value>|--verdict_config=<value>]] [--log=<value>] "      .
   "[--workdir=<value>] [--script_debug=<value>]\n\n"                                              .
   "Some typical calls:\n"                                                                         .
   "    # Check some RQG run.\n"                                                                   .
   "    perl verdict.pl --log=<whatever>/000013.log\n"                                             .
   ...
   "    perl verdict.pl --batch_config=simp97.cfg --log=<whatever>/000013.log\n"                   .
   ...
   "    perl verdict.pl --verdict_config=Verdict.cfg --log=last_batch_workdir/000013.log\n"        .
...
sub make_verdict_config {
    ...
    # check_and_set_config_file transforms $config_file to go with absolute path.
    check_and_set_config_file();
